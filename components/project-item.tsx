			...
			>
				...
				<div className='sm:col-span-6 sm:order-2'>
					...
					<div className='flex gap-6 mb-4'>
						{github && (
							<a
								className=' inline-flex items-center font-medium text-sm leading-tight text-[#9b1c47] hover:text-primary focus-visible:text-primary transition duration-300 group/link'
								href={github}
								target='_blank'
								rel='noreferrer'
								aria-label='Github'
						...
						{live && (
							<a
								className='inline-flex items-center font-medium leading-tight text-sm text-[#9b1c47] hover:text-primary focus-visible:text-primary transition duration-300 group/link'
								href={live}
								target='_blank'
								rel='noreferrer'
								aria-label='Live'
